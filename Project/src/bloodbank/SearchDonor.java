...
public class SearchDonor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 70, 70));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(122, 218, 165));
        jLabel14.setText("Blood Bank");
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 110, 30));
        ...
        jRadioButton2.setText("Donor ID");
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 460, -1, -1));

        jLabel11.setFont(new java.awt.Font("Yu Gothic Medium", 1, 18)); // NOI18N
        jLabel11.setText("Search Donor");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 290, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 520, 820, 210));
   ...
   if(hg.equals(""))
        {
            ...
            try {
                ...
                if (jRadioButton1.isSelected() == true) {
                    ...
                    query = "Select * from donor where dname like \"%" + str + "%\";";
            ...
            rs.close();
                ...
                query = "Select * from donor where did=" + aid + ";";
    ...
    private void jLabel15MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel15MousePressed
        ...
        if(hg.equals(""))
        {
            ...
            try {
                ...
                if (jRadioButton1.isSelected() == true) {
                    str = jTextField1.getText();
                    query = "delete from donor where dname like \"" + str + "\";";
